...
/**
 * Runs validation on the given input params
 * and formats the request url to send to the fetch function
 * @param {array} states 
 * @param {array} names 
 * @param {array} tags 
 * @param {array} types 
...
/**
 * Allows the user to filter on various params in their get request
 * agains the Open Brewery API
 * @param {array} states 
 * @param {array} names 
 * @param {array} tags 
 * @param {array} types 
